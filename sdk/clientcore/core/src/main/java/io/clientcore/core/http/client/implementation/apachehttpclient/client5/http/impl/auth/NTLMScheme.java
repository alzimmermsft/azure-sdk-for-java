...
public final class NTLMScheme implements AuthScheme {
    ...
    private io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.NTCredentials credentials;
    ...
    public boolean isResponseReady(
        ...
        if (credentials instanceof org.apache.hc.client5.http.auth.NTCredentials) {
            this.credentials = (io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.NTCredentials) credentials;
            return true;
        }
