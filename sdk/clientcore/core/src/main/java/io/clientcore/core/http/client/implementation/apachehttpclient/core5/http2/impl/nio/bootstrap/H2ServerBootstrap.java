 ...
 *
 */
package io.clientcore.core.http.client.implementation.apachehttpclient.core5.http2.impl.nio.bootstrap;
...
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.function.Supplier;
...
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.impl.DefaultConnectionReuseStrategy;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.impl.DefaultContentLengthStrategy;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.impl.Http1StreamListener;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.impl.HttpProcessors;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.impl.bootstrap.HttpAsyncServer;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.impl.bootstrap.StandardFilter;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.impl.nio.DefaultHttpRequestParserFactory;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.impl.nio.DefaultHttpResponseWriterFactory;
...
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.impl.routing.RequestRouter;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.nio.AsyncFilterHandler;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.nio.AsyncServerExchangeHandler;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.nio.AsyncServerRequestHandler;
...
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.nio.support.AsyncServerExpectationFilter;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.nio.support.AsyncServerFilterChainElement;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.nio.support.AsyncServerFilterChainExchangeHandlerFactory;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.nio.support.BasicAsyncServerExpectationDecorator;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.nio.support.BasicServerExchangeHandler;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.nio.support.DefaultAsyncResponseExchangeHandlerFactory;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.nio.support.TerminalAsyncServerFilter;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.protocol.HttpProcessor;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.protocol.UriPatternType;
...
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http2.impl.H2Processors;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http2.impl.nio.H2StreamListener;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http2.impl.nio.ServerH2StreamMultiplexerFactory;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http2.impl.nio.ServerHttpProtocolNegotiationStarter;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http2.ssl.H2ServerTlsStrategy;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.net.InetAddressUtils;
...
public class H2ServerBootstrap {
    ...
    private io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.protocol.LookupRegistry<Supplier<AsyncServerExchangeHandler>> lookupRegistry;
     ...
     */
    @Deprecated
    public final H2ServerBootstrap setLookupRegistry(final io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.protocol.LookupRegistry<Supplier<AsyncServerExchangeHandler>> lookupRegistry) {
    ...
    public HttpAsyncServer create() {
        ...
        if (lookupRegistry != null && requestRouter == null) {
            final io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.protocol.RequestHandlerRegistry<Supplier<AsyncServerExchangeHandler>> handlerRegistry = new org.apache.hc.core5.http.protocol.RequestHandlerRegistry<>(
