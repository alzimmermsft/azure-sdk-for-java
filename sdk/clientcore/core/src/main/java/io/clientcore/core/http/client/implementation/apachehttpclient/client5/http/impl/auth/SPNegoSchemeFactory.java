...
public class SPNegoSchemeFactory implements AuthSchemeFactory {
     ...
     */
    public static final SPNegoSchemeFactory DEFAULT = new SPNegoSchemeFactory(io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.KerberosConfig.DEFAULT,
     ...
     * @since 5.0
     */
    public SPNegoSchemeFactory(final io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.KerberosConfig config, final DnsResolver dnsResolver) {
        super();
        this.config = config;
