...
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.impl.io.DefaultHttpResponseParser;
...
public class LenientHttpResponseParser extends DefaultHttpResponseParser {
     ...
     *                        {@link io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.message.BasicLineParser#INSTANCE} will be used.
     * @param responseFactory HTTP response factory. If {@code null}
     *                        {@link io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.impl.io.DefaultClassicHttpResponseFactory#INSTANCE}
     *                        will be used.
