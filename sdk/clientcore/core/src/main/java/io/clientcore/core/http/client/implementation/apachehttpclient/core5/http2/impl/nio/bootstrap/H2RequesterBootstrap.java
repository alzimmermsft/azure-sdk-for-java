...
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.annotation.Experimental;
...
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.impl.nio.ClientHttp1StreamDuplexerFactory;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.impl.nio.DefaultHttpRequestWriterFactory;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.impl.nio.DefaultHttpResponseParserFactory;
...
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http2.impl.nio.ClientH2StreamMultiplexerFactory;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http2.impl.nio.ClientHttpProtocolNegotiationStarter;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http2.impl.nio.H2StreamListener;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http2.nio.support.DefaultAsyncPushConsumerFactory;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http2.ssl.H2ClientTlsStrategy;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.pool.ConnPoolListener;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.pool.DefaultDisposalCallback;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.pool.LaxConnPool;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.pool.ManagedConnPool;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.pool.PoolConcurrencyPolicy;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.pool.PoolReusePolicy;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.pool.StrictConnPool;
