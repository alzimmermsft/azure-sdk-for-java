...
public class KerberosSchemeFactory implements AuthSchemeFactory {
     ...
     */
    public static final KerberosSchemeFactory DEFAULT = new KerberosSchemeFactory(io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.KerberosConfig.DEFAULT,
     ...
     * @since 5.0
     */
    public KerberosSchemeFactory(final io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.KerberosConfig config, final DnsResolver dnsResolver) {
        super();
        this.config = config;
