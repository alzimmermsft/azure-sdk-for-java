...
public class KerberosScheme extends GGSSchemeBase {
     ...
     * @since 5.0
     */
    public KerberosScheme(final io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.KerberosConfig config, final DnsResolver dnsResolver) {
