 ...
 *
 */
package io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.impl.auth;

import java.net.UnknownHostException;
import java.security.Principal;

import io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.DnsResolver;
import io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.SystemDefaultDnsResolver;
import io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.AuthChallenge;
import io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.AuthScheme;
import io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.AuthScope;
import io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.AuthenticationException;
import io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.Credentials;
import io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.CredentialsProvider;
import io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.InvalidCredentialsException;
import io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.MalformedChallengeException;
...
import io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.utils.Base64;
...
public abstract class GGSSchemeBase implements AuthScheme {
    ...
    private final io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.KerberosConfig config;
    ...
    GGSSchemeBase(final io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.KerberosConfig config, final DnsResolver dnsResolver) {
        super();
    ...
    GGSSchemeBase(final io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.KerberosConfig config) {
        this(config, SystemDefaultDnsResolver.INSTANCE);
    }

    GGSSchemeBase() {
        this(io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.KerberosConfig.DEFAULT, SystemDefaultDnsResolver.INSTANCE);
    }
    ...
    protected GSSContext createGSSContext(
        ...
        if (config.getRequestDelegCreds() != io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.KerberosConfig.Option.DEFAULT) {
            gssContext.requestCredDeleg(config.getRequestDelegCreds() == io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.KerberosConfig.Option.ENABLE);
        }
        return gssContext;
    }
    /**
    ...
    public boolean isResponseReady(
        ...
        if (credentials instanceof org.apache.hc.client5.http.auth.KerberosCredentials) {
            this.gssCredential = ((io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.KerberosCredentials) credentials).getGSSCredential();
        } else {
    ...
    public String generateAuthResponse(
        ...
        case CHALLENGE_RECEIVED:
            try {
                ...
                if (config.getUseCanonicalHostname() != io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.KerberosConfig.Option.DISABLE){
                    try {
                         hostname = dnsResolver.resolveCanonicalHostname(host.getHostName());
                    } catch (final UnknownHostException ignore){
                    }
                }
                if (config.getStripPort() != io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.KerberosConfig.Option.DISABLE) {
                    authServer = hostname;
                } else {
