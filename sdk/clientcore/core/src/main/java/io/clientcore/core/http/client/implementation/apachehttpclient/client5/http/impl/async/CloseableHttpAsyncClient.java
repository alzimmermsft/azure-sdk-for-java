...
import io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.async.HttpAsyncClient;
import io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.async.methods.SimpleHttpRequest;
import io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.async.methods.SimpleHttpResponse;
import io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.async.methods.SimpleRequestProducer;
import io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.async.methods.SimpleResponseConsumer;
...
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.reactor.IOReactorStatus;
...
public abstract class CloseableHttpAsyncClient implements HttpAsyncClient, ModalCloseable {
    ...
    /**
     * @deprecated Use {@link io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.impl.routing.RequestRouter}
