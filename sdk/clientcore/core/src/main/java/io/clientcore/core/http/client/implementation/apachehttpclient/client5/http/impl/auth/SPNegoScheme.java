...
public class SPNegoScheme extends GGSSchemeBase {
     ...
     * @since 5.0
     */
    public SPNegoScheme(final io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.auth.KerberosConfig config, final DnsResolver dnsResolver) {
