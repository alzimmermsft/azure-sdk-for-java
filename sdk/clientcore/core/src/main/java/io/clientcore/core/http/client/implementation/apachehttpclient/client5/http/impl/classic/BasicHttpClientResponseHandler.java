...
/**
 * A {@link io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.io.HttpClientResponseHandler} that returns
 * the response body as a String for successful (2xx) responses. If the response
 * code was &gt;= 300, the response body is consumed
 * and an {@link io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.HttpResponseException} is thrown.
 * <p>
 * If this is used with
 * {@link io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.classic.HttpClient#execute(
