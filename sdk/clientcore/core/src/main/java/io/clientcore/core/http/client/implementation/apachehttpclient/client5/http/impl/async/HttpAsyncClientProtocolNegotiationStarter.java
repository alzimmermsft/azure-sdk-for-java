...
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.impl.nio.ClientHttp1IOEventHandler;
...
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.nio.NHttpMessageParserFactory;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http.nio.NHttpMessageWriterFactory;
...
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http2.frame.FramePrinter;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http2.frame.RawFrame;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http2.impl.nio.ClientH2PrefaceHandler;
...
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http2.impl.nio.ClientH2UpgradeHandler;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http2.impl.nio.ClientHttp1UpgradeHandler;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http2.impl.nio.H2StreamListener;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http2.impl.nio.HttpProtocolNegotiator;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.http2.ssl.ApplicationProtocol;
import io.clientcore.core.http.client.implementation.apachehttpclient.core5.reactor.IOEventHandler;
...
class HttpAsyncClientProtocolNegotiationStarter implements IOEventHandlerFactory {
    ...
    private static final Logger HEADER_LOG = LoggerFactory.getLogger("io.clientcore.core.http.client.implementation.apachehttpclient.client5.http.headers");
    private static final Logger FRAME_LOG = LoggerFactory.getLogger("io.clientcore.core.http.client.implementation.apachehttpclient.client5.http2.frame");
    private static final Logger FRAME_PAYLOAD_LOG = LoggerFactory.getLogger("io.clientcore.core.http.client.implementation.apachehttpclient.client5.http2.frame.payload");
    private static final Logger FLOW_CTRL_LOG = LoggerFactory.getLogger("io.clientcore.core.http.client.implementation.apachehttpclient.client5.http2.flow");
